...
```{r}
count.table$pvalue <- ppois(q=count.table$counts.input, lambda = count.table$input.scaled.median, lower.tail = FALSE)
```
...
par(mfrow=c(2,1))
plot(count.table$midpos, count.table$counts.chip)
par(mfrow=c(1,1))
```
