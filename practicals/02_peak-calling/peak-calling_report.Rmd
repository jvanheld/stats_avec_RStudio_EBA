...
```{r}
#url.course <- "~/roscoff_2015/stats_avec_RStudio_EBA15/" # For JvH local test only
url.course <- "http://jvanheld.github.io/EBA15_stats_RStudio/"
url.data <- file.path(dir.base, "practicals", "02_peak-calling", "data")
