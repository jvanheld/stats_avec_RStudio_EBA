...
# Generating a unique data table
...
In the View pane, switch back and forth between WT and Snf2 tabs to check the differences.
...
Exercise: select two random subsets of the same genotype (WT versus WT, or Snf2 versus Snf2) and run the differential analysis as above, with either DESeq2 or edgeR.

- How many genes are declared positive? 
- Does the histogram of P-values appear flat?
- How does the volcano plot compare with the WT versus Snf2 result obtained above?
