...
hist(count.table$scaled.ratio.libsum, breaks=2000, xlim=c(0, 5), xlab="Count ratios after libsum scaling", main="Count ratio histogram")
abline(v=mean(count.table$scaled.ratio.libsum), col="darkgreen", lwd=3, lty="dashed")
abline(v=median(count.table$scaled.ratio.libsum), col="brown", lwd=3)
legend("topright", c("mean", "median"), col=c("darkgreen", "brown"), lwd=3)
...
hist(count.table$input.scaled.median, breaks=2000, xlim=c(-5, 5), xlab="Count ratios after libsum scaling", main="Count ratio histogram")
abline(v=mean(count.table$scaled.ratio.median), col="darkgreen", lwd=3, lty="dashed")
abline(v=median(count.table$scaled.ratio.median), col="brown", lwd=3)
legend("topright", c("mean", "median"), col=c("darkgreen", "brown"), lwd=3)
